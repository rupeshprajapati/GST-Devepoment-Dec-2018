...
namespace udManufacturerMast
{
    public partial class Form1 : uBaseForm.FrmBaseForm
    {
        ...
        public Form1(string[] args)
        {
            ...
            this.pPApplPID = 0;
            this.pPara = args;
            this.pFrmCaption = "Manufacturer Master";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            SqlStr = "SELECT ROW_NUMBER() OVER(ORDER BY name) number, mid, name  FROM    pRetManufacturerMast where name != '' order by name";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dtManufacturer.Rows.Count == 0)
            {
                    ...
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        SqlStr = "Delete from pRetManufacturerMast where Name='" + txtName.Text.ToString().Trim().Replace("'", "''") + "'";
            ...
            {
                MessageBox.Show(" You cannot delete this Manufacturer , It is already used in Supply Master.", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Manufacturer Name cannot be empty.", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                txtName.Focus();
            }
            else if ((dtManufacturer.Rows.Count > 0) && this.pAddMode == true)
            {
                MessageBox.Show("Manufacturer already exist.", this.pPApplText, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                txtName.Focus();
            }
            else
            {
        ...
        private void btnUpload_Click(object sender, EventArgs e)
        {
            ...
            fu.pPara = this.pPara;
            fu.pFrmCaption = "Upload Manufacturer Master";
        ...
        private void txtArea_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode.ToString() == "F2")
            {
                string VForText = string.Empty, vSearchCol = string.Empty, strSQL = string.Empty, Vstr = string.Empty, vColExclude = string.Empty, vDisplayColumnList = string.Empty, vReturnCol = string.Empty;
                DataSet tDs = new DataSet();
                SqlStr = "Select Distinct Area From pRetManufacturerMast Where Area <> ''";
        ...
        private void btnFirst_Click(object sender, EventArgs e)
        {
            ...
            //SqlStr = "select top 1 mid from pRetManufacturerMast order by Name";
            //dtManufacturerDet = new DataTable();
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            //    SqlStr = "select  mid from pRetManufacturerMast where mid=(select top 1 mid from pRetManufacturerMast where mid <(select mid from pRetManufacturerMast where mid='" + ManufacturerID + "') order by Name desc )";
            //dtManufacturerDet = new DataTable();
            //dtManufacturerDet = oDataAccess.GetDataTable(SqlStr, null, 20);
        ...
        private void btnForward_Click(object sender, EventArgs e)
        {
            ...
            //SqlStr = "select  mid from pRetManufacturerMast where mid=(select top 1 mid from pRetManufacturerMast where mid >(select mid from pRetManufacturerMast where mid='" + ManufacturerID + "') order by Name  )";
            //dtManufacturerDet = new DataTable();
            //dtManufacturerDet = oDataAccess.GetDataTable(SqlStr, null, 20);
        ...
        private void btnLast_Click(object sender, EventArgs e)
        {
            ...
            //SqlStr = "select top 1 mid from pRetManufacturerMast order by Name desc";
            //dtManufacturerDet = new DataTable();
            //dtManufacturerDet = oDataAccess.GetDataTable(SqlStr, null, 20);
        ...
        private void btnName_Click(object sender, EventArgs e)
        {
            string VForText = string.Empty, vSearchCol = string.Empty, strSQL = string.Empty, Vstr = string.Empty, vColExclude = string.Empty, vDisplayColumnList = string.Empty, vReturnCol = string.Empty;
            DataSet tDs = new DataSet();
            SqlStr = "select mid,Name from pRetManufacturerMast order by Name";

            tDs = oDataAccess.GetDataSet(SqlStr, null, 20);
            DataView dvw = tDs.Tables[0].DefaultView;
            VForText = "Select Manufacturer Name ";
            vSearchCol = "Name";
        ...
        private void mInsertProcessIdRecord()
        {
            ...
            cAppName = "udManufacturerMast.exe";
        ...
        {
            SqlStr = "select * from pRetManufacturerMast where mid='" + ManufacturerID + "'";
            dtManufacturerDet = new DataTable();
            dtManufacturerDet = oDataAccess.GetDataTable(SqlStr, null, 20);
        ...
        public void InsertUpdate()
        {
            try
            {
                ...
                {
                    oDataAccess.BeginTransaction();
                    SqlStr = "set dateformat dmy update pRetManufacturerMast set ";
                    ...
                    SqlStr = SqlStr + "phone = '" + office + "', fax = '" + fax + "', phoner = '" + phoner + "', mobile = '" + cellno + "', email = '" + email + "',prDrugLicNo='" + prDrugLicNo + "',prDrugExpDate='" + prDrugExpDate + "',prFoodLicNo='" + prFoodLicNo + "',prFoodExpDate='" + prFoodExpDate + "',marketedby='" + marketedby + "',mcode='"+mcode+"'";
