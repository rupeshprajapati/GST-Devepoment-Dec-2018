...
namespace PointofSale
{
    public class EvalFunctions : iEvalFunctions, iVariableBag
    {
        ...
        public event udEvaluate.iEvalValue.ValueChangedEventHandler ValueChanged;
        ...
        public iEvalTypedValue GetVariable(string varname)
        {
            ...
            {
                case "pa":
                    return new udEvaluate.EvalVariable("pa", 12.0, "PA is the age of the programmer", typeof(double));
                case "vat":
                    return new udEvaluate.EvalVariable("vat", 12.5, "V.A.T.", typeof(double));
            }
            return null;
        }
    }
