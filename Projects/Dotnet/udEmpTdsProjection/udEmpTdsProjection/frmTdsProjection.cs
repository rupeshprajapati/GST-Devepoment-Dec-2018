...
namespace udEmpTdsProjection
{
    public partial class frmTdsProjection : uBaseForm.FrmBaseForm
    {
        ...
        private void btnTDSProjection_Click(object sender, EventArgs e)
        {
            ...
            this.stbMain.Refresh();
           // this.StbLbl.Text = "";  //Commented by Prajakta B. on 13062018 for Bug 31623
            this.stbMain.Text = "";
            this.stbMain.Refresh();
        ...
        private void mthPrint(Int16 vPrintOption)
        {
            ...
            this.stbMain.Refresh();
            //this.stbMain.Refresh();  //Commented by Prajakta B. on 13062018 for Bug 31623
        ...
        private void dgrMain_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
