...
namespace eMailClient.MailSender
{
    public class cls_Gen_Ent_MailSender
    {
        ...
        //Added by Shrikant S. on 24/09/2018 for Bug-31906      //Start
        private bool issmtpDefault;
        public bool IsSmtpDefault
        {
            get { return issmtpDefault; }
            set { issmtpDefault = value; }
        }
        //Added by Shrikant S. on 24/09/2018 for Bug-31906      //End
    }
}
