    ...
    public class cls_Gen_Mgr_Email_Settings : cls_Gen_Ent_Email_Settings,ICommonBLL
    {
       ...
       /// public cls_Gen_Mgr_Email_Settings(Int32 CompanyID, string Server, string User, string Pass)
        ...
        public enum eMailClient_RowName : int
        {
            ...
            port,
            enablessl,
            smtpdefault                     //Added by Shrikant S. on 24/09/2018 for Bug-31906
        }
        #endregion
        ...
        public void Insert()
        {
            ...
            {   
                ...
                m_execute = cls_Sqlhelper.ExecuteNonQuery(sqltran, CommandType.Text, "Insert into eMailSettings(Yourname,Username,Password,Host,Port,"+
                    "EnableSSL,isSmtpDefa) values('" + Yourname.Trim() + "','" + Username.Trim() + "','" + pwd + "','" + Host.Trim() + "'," +
                    //"EnableSSL) values('" + Yourname.Trim() + "','" + Username.Trim() + "','" + pwd + "','" + Host.Trim() + "'," + 
                    Convert.ToString(Port) + ",'" + Convert.ToBoolean(Enablessl) +"','"+Convert.ToBoolean(SmtpDefault)+ "')");
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                m_execute = cls_Sqlhelper.ExecuteNonQuery(sqltran, CommandType.Text, "Update eMailSettings set Yourname='" + Yourname.Trim() + "',Username='" +
                    ...
                    Convert.ToBoolean(Enablessl) + "'" + ",IssmtpDefa='" + Convert.ToBoolean(SmtpDefault)+"'");          //Added by Shrikant S. on 25/09/2018 for bug-31906
                    //Convert.ToBoolean(Enablessl) + "'");          //Commented by Shrikant S. on 25/09/2018 for bug-31906
        ...
        private void Binding(DataRow m_rowDsSelect)
        {
            ...
            SmtpDefault= Convert.ToBoolean(m_rowDsSelect["isSmtpDefa"]);        // Added by Shrikant S. on 25/09/2018 for Bug-31906
        }
