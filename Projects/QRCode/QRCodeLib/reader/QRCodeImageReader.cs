...
using Udyog.QRCode.Codec.Data;
using AlignmentPatternNotFoundException = Udyog.QRCode.ExceptionHandler.AlignmentPatternNotFoundException;
using FinderPatternNotFoundException = Udyog.QRCode.ExceptionHandler.FinderPatternNotFoundException;
...
using VersionInformationException = Udyog.QRCode.ExceptionHandler.VersionInformationException;
using Udyog.QRCode.Geom;
using Udyog.QRCode.Codec.Reader.Pattern;
using Udyog.QRCode.Codec.Util;
using SystemUtils = Udyog.QRCode.Codec.Util.SystemUtils;

namespace Udyog.QRCode.Codec.Reader
{
	...
	public class QRCodeImageReader
	{
		...
		internal virtual bool[][] getQRCodeMatrix(bool[][] image, SamplingGrid gridLines)
		{
			...
			canvas.drawPoint(bottomRightPoint, Udyog.QRCode.Codec.Util.Color_Fields.BLUE);
