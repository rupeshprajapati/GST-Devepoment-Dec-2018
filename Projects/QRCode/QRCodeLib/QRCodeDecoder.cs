...
using QRCodeImage = Udyog.QRCode.Codec.Data.QRCodeImage;
using QRCodeSymbol = Udyog.QRCode.Codec.Data.QRCodeSymbol;
using ReedSolomon = Udyog.QRCode.Codec.Ecc.ReedSolomon;
using DecodingFailedException = Udyog.QRCode.ExceptionHandler.DecodingFailedException;
using InvalidDataBlockException = Udyog.QRCode.ExceptionHandler.InvalidDataBlockException;
using SymbolNotFoundException = Udyog.QRCode.ExceptionHandler.SymbolNotFoundException;
using Point = Udyog.QRCode.Geom.Point;
using QRCodeDataBlockReader = Udyog.QRCode.Codec.Reader.QRCodeDataBlockReader;
using QRCodeImageReader = Udyog.QRCode.Codec.Reader.QRCodeImageReader;
using DebugCanvas = Udyog.QRCode.Codec.Util.DebugCanvas;
using DebugCanvasAdapter = Udyog.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = Udyog.QRCode.Codec.Util.QRCodeUtility;

namespace Udyog.QRCode.Codec
{
