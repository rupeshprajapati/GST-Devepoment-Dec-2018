...
namespace UdMISReports
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length <=0 )
            {
                args = new string[] { "MSALER|[FParty=][TParty=work order]||[FDate=04/01/2018][TDate=04/01/2018]", "19", "U151819", @"AIPLDTM019\SQLEXPRESS", "sa", "sa1985", "^19031", "ADMIN", @"E:\U3\UdyogERPSDK\Bmp\Icon_VudyogGST.ico", "UdyogERPSDK", "UdyogERPSDK.EXE", "4764", "udPID4764DTM20111213125821", "", "", "E:\\u3\\UdyogERPSDK\\", "01-04-2018", "31-03-2019" };
