...
Case Inlist(Upper(Alltrim(mudprodcode)),'ITAX','USQUARE','VUDYOGSDK','VUDYOGGSSDK','UERPSDK')			&& Changed by Sachin N. S. on 28/09/2018 for ERP SDK
...
Case Inlist(Upper(Alltrim(mudprodcode)),'VUDYOGSTD','VUDYOGPRO','VUDYOGENT','10USQUARE','10ITAX','VUDYOGGST','UERPSTD','UERPSILVPRO','UERPGOLDPRO','UERPENT')			&& Changed by Sachin N. S. on 27/01/2017 for ERP
