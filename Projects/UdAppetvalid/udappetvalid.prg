...
*	llreturn=.T.
	...
	Endscan
	If Alltrim(lcsrno)<>""			&& Added by Shrikant S. on 29/09/2018 for Installer ENT 2.0.0
...
&&Added by Priyanka B on 29032019 for Bug-32067 Start
Procedure GetPopValue
	Parameters _Object
		...
		If oGlblPrdFeat.UdChkProd('vuisd') Or oGlblPrdFeat.UdChkProd('isdkgen')
			Do Case
				Case Inlist(main_vw.entry_ty,"GC","GD")
					_Object.Clear
					_Object.AddItem("")
					_Object.AddItem("Domestic Purchases")
					_Object.AddItem("Branch Transfer")
					_Object.AddItem("SEZ Developer Purchase")
					_Object.AddItem("SEZ Unit Purchase")
					
				Case main_vw.entry_ty="IB"
					_Object.Clear
					_Object.AddItem("")
					_Object.AddItem("Invoice Credit Mismatch")
					_Object.AddItem("Redistribution of ITC distributed to a wrong recipient")
					
				Case main_vw.entry_ty="PT"
					_Object.Clear
					_Object.AddItem("")
					_Object.AddItem("Branch Transfer")
					_Object.AddItem("Consignment Transfer")
					_Object.AddItem("Domestic Purchases")
					_Object.AddItem("SEZ Developer Purchase")
					_Object.AddItem("SEZ Unit Purchase")
			Endcase
	...
	Endif
	Return
&&Added by Priyanka B on 29032019 for Bug-32067 End
