...
SELECT distinct GSTIN=case when ac_mast.GSTIN='UNREGISTERED' THEN '' else ac_mast.GSTIN end,ir_state=st.LetrCode
...
SELECT distinct GSTIN=case when ac_mast1.GSTIN='UNREGISTERED' THEN '' else ac_mast1.GSTIN end,st1.LetrCode as ir_state
...
SELECT  distinct  '' as GSTIN,st.LetrCode as ir_state
