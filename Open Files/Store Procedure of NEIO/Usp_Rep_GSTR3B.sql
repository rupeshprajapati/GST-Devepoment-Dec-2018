	...
	/* 3.1 Details of Outward Supplies and inward supplies liable to reverse charge*/
		...
		----(d) Inward supplies (liable to reverse charge)
		 ...
		 ----Reverse change 
			...
			FROM #GSTR3BTBL g WHERE mEntry IN ('BP','CP','EP','CN','DN','PR','PT') AND st_type IN('INTRASTATE','INTERSTATE','OUT OF COUNTRY') AND SUPP_TYPE not in('Unregistered') AND AGAINSTGS in('','PURCHASES','SERVICE PURCHASE BILL','GOODS','SERVICES')
